...
/***/ (function(module, exports, __webpack_require__) {
	...
	var raceApi = __webpack_require__(9);
	var raceUi = __webpack_require__(11);
	var authApi = __webpack_require__(39);
	var authUi = __webpack_require__(40);
	...
	var showSignUpForm = function showSignUpForm(event) {
	  event.preventDefault
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  ();var data = getFormFields(this);
	  authApi.signIn(data).then(authUi.signInSuccess
	  // if user is successful render the home page
	  ).then(displayAllRaces).catch(authUi.signInFailure);
	};

	var showLogInForm = function showLogInForm(event) {
	  event.preventDefault
	...
	var onSignOut = function onSignOut(event) {
	  ...
	  ();authApi.signOut().then(authUi.signOutSuccess).then(onShowLandingPage).catch(authUi.signOutFailure);
	};
	...
	var displayChangePassModal = function displayChangePassModal(event) {
	  event.preventDefault
	...
	var onClosePassModal = function onClosePassModal(event) {
	  event.preventDefault();
	  $('.pass-success-message').hide();
	  $('.old-password-mismatch-message').hide();
	...
	var displayAllRaces = function displayAllRaces() {
	  // console.log('display all races function ran')
	  raceApi.indexRaces().then(function (data) {
	...
	// SHOW ADD RACE MODAL
	var displayAddRaceModal = function displayAddRaceModal(event) {
	...
	var addRace = function addRace(event) {
	  // console.log('add race button was clicked inside add race modal')
	  event.preventDefault();
	  var data = getFormFields(event.target
	  // convert user input into seconds to send to API
	  );var hours = $('#hours').val() * 60 * 60;
	  var mins = $('#minutes').val() * 60;
	  var seconds = $('#seconds').val() * 1;
	  var timeInSeconds = hours + mins + seconds;
	  ...
	  raceApi.createRace(data, timeInSeconds).then(createRaceSuccess).catch(onError);
	};

	// SUCCESS FUNCTION
	var createRaceSuccess = function createRaceSuccess() {
	...
	var onDeleteRace = function onDeleteRace() {
	  // console.log('on delete race ran', this)
	  var id = $(this).attr('data-id');
	  raceApi.destroyRace(id).then(displayAllRaces).catch(onError);
	};

	// show one race function when update button is pressed
	var displayUpdateModal = function displayUpdateModal() {
	  // console.log('display update modal was clicked')
	  event.preventDefault();
	  var id = $(this).attr('data-id');
	  raceApi.showRace(id).then(prefilleRaceFields).then(showUpdateModal).catch(onError);
	};

	// push the fields from the show to the update
	var prefilleRaceFields = function prefilleRaceFields(data) {
	  ...
	  var hours = moment.utc(data.race.time * 1000).format('HH');
	  var minutes = moment.utc(data.race.time * 1000).format('HH:mm').slice(3, 5);
	  var seconds = moment.utc(data.race.time * 1000).format('HH:mm:ss').slice(6, 8);
	...
	var showUpdateModal = function showUpdateModal() {
	  $('#update-race-modal').modal({ show: true });
	};

	var onUpdateRace = function onUpdateRace(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var id = $(this).attr('data-id'
	  // console.log(this)
	  // console.log('updateRace ran', id, data)
	  );var hours = $('#update-hours').val() * 60 * 60;
	  var mins = $('#update-minutes').val() * 60;
	  var seconds = $('#update-seconds').val() * 1;
	  var timeInSeconds = hours + mins + seconds;
	  // console.log(timeInSeconds)
	  raceApi.patchRace(id, data, timeInSeconds).then(updateRaceSuccess).catch(onError);
	};

	var updateRaceSuccess = function updateRaceSuccess() {
	  // console.log('create Race Success ran')
	  $('body').removeClass('modal-open');
	  displayAllRaces();
	};
	...
	module.exports = {
	  ...
	  displayAllRaces: displayAllRaces,
	  displayAddRaceModal: displayAddRaceModal
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// show all races
	);var indexRaces = function indexRaces() {
	  return $.ajax({
	...
	// show one race
	var showRace = function showRace(id) {
	...
	// create one race
	var createRace = function createRace(data, timeInSeconds) {
	...
	// update a race
	var patchRace = function patchRace(id, data, timeInSeconds) {
	  var race = {
	    race: {
	      distance: data.race.distance,
	      time: timeInSeconds,
	...
	// delete race
	var destroyRace = function destroyRace(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/races/' + id,
	    method: 'DELETE',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showLandingPageTemplate = __webpack_require__(12);
	var showHomePageTemplate = __webpack_require__(33
	...
	// builds the homepage
	var showHomePage = function showHomePage(data) {
	  $('.body-content').empty();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(32),depth0,{"name":"sign-up-sign-in","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"nav-bar","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + ((stack1 = container.invokePartial(__webpack_require__(36),depth0,{"name":"all-races-list","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + ((stack1 = container.invokePartial(__webpack_require__(37),depth0,{"name":"add-race","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + ((stack1 = container.invokePartial(__webpack_require__(38),depth0,{"name":"update-race","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(35),depth0,{"name":"change-password","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "      <tr>\n        <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.race_day : stack1), depth0))
	    + "</td>\n        <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
	    + "</td>\n        <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.distance : stack1), depth0))
	    + "</td>\n        <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.race_pace : stack1), depth0))
	    + "</td>\n        <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.time : stack1), depth0))
	    + "</td>\n        <td>\n          <button type=\"button\" class=\"btn btn-default update-button\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n            <span class=\"glyphicon glyphicon-pencil\" aria-hidden=\"true\"></span>\n          </button>\n        </td>\n        <td>\n          <button type=\"button\" class=\"btn btn-default delete-button\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n            <span class=\"glyphicon glyphicon-trash\" aria-hidden=\"true\"></span>\n          </button>\n        </td>\n      </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div class=\"jumbotron\">\n    <p class= \"inspo-quote\">to give anything less than your best is to sacrifice the gift</p>\n</div>\n<!-- use data-id not just id-->\n  <table class=\"table table-responsive\" id='race-table'>\n  <thead class=\"thead-default\">\n    <tr>\n      <th colspan=\"1\">Race Date</th>\n      <th colspan=\"1\">Location</th>\n      <th colspan=\"1\">Distance</th>\n      <th colspan=\"1\">Pace</th>\n      <th colspan=\"1\">Result</th>\n      <th colspan=\"2\"></th>\n    </tr>\n    </thead>\n\n    <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.races : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n    </tbody>\n</table>\n\n<button type=\"button\" style=\"float:right\" class=\"btn btn-default add-race-btn\">Add Race</button>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<!-- Add Race Modal -->\n<form id=\"add-race\">\n<fieldset>\n<div id=\"add-race-modal\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n    <div class=\"modal-header\">\n        <h3>Add a race <span class=\"extra-title muted\"></span></h3>\n    </div>\n    <div class=\"modal-body form-horizontal\">\n      <!-- Race Day  -->\n        <div class=\"control-group\">\n            <label for=\"race_day\" class=\"control-label\">Race Date</label>\n            <div class=\"controls\">\n              <input type=\"date\" id=\"race\" name=\"race[race_day]\" min=\"1900-01-01\" max=\"2500-01-01\" required>\n            </div>\n        </div>\n        <!-- Race Location -->\n        <div class=\"control-group\">\n            <label for=\"race_location\" class=\"control-label\">Race Location</label>\n            <div class=\"controls\">\n                <input type=\"text\" name=\"race[location]\" required>\n            </div>\n        </div>\n        <!-- Race Distance -->\n        <div class=\"control-group\">\n          <label for=\"race_distance\">Distance</label>\n          <select class=\"form-control controls\" id=\"race-distance\" name=\"race[distance]\">\n            <option value=\"3.1\">5k</option>\n            <option value=\"6.2\">10k</option>\n            <option value=\"13.1\">Half Marathon</option>\n            <option value=\"26.2\">Marathon</option>\n          </select>\n        </div>\n        <!--Race Time -->\n        <div class=\"control-group\" name = \"race[time]\">\n            <label for=\"race_time\" class=\"control-label\">Result</label>\n            <div>\n            <input type=\"text\" id=\"hours\" class=\"time-input\" value=\"0\" maxlength=\"2\" required/> hr\n            <input type=\"text\" id=\"minutes\" class=\"time-input\" value=\"0\" maxlength=\"2\" required/> min\n            <input type=\"text\" id=\"seconds\" class=\"time-input\" value=\"0\" maxlength=\"2\" required /> sec\n          </div>\n        </div>\n    <div class=\"modal-footer\">\n        <button type = \"button\" class=\"btn cls-add-race-modal\" data-dismiss=\"modal\" aria-hidden=\"true\">Close</button>\n        <button type = \"submit\" class=\"btn btn-primary\" >Save changes</button>\n    </div>\n  </div>\n</div>\n</div>\n</fieldset>\n</form>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<!-- Add Race Modal -->\n<form id=\"update-race\">\n<fieldset>\n<div id=\"update-race-modal\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n    <div class=\"modal-header\">\n        <h3>Update Race <span class=\"extra-title muted\"></span></h3>\n    </div>\n    <div class=\"modal-body form-horizontal\">\n      <!-- Race Day  -->\n        <div class=\"control-group\">\n            <label for=\"race_day\" class=\"control-label\">Race Date</label>\n            <div class=\"controls\">\n              <input type=\"date\" id=\"race-day\" name=\"race[race_day]\" min=\"1900-01-01\" max=\"2500-01-01\" required>\n            </div>\n        </div>\n        <!-- Race Location -->\n        <div class=\"control-group\">\n            <label for=\"race_location\" class=\"control-label\">Race Location</label>\n            <div class=\"controls\">\n                <input type=\"text\" name=\"race[location]\" id = \"race-location\" required>\n            </div>\n        </div>\n        <!-- Race Distance -->\n        <div class=\"control-group\">\n          <label for=\"race_distance\">Distance</label>\n          <select class=\"form-control controls\" id=\"race-distance\" name=\"race[distance]\">\n            <option value=\"3.1\">5k</option>\n            <option value=\"6.2\">10k</option>\n            <option value=\"13.1\">Half Marathon</option>\n            <option value=\"26.2\">Marathon</option>\n          </select>\n        </div>\n        <!--Race Time -->\n        <div class=\"control-group\" name = \"race[time]\">\n            <label for=\"race_time\" class=\"control-label\">Result</label>\n            <div>\n            <input type=\"text\" id=\"update-hours\" class=\"time-input\" value=\"0\" maxlength=\"2\" required/> hr\n            <input type=\"text\" id=\"update-minutes\" class=\"time-input\" value=\"0\" maxlength=\"2\" required/> min\n            <input type=\"text\" id=\"update-seconds\" class=\"time-input\" value=\"0\" maxlength=\"2\" required/> sec\n          </div>\n        </div>\n    <div class=\"modal-footer\">\n        <button type = \"button\" class=\"btn cls-update-race-modal\" data-dismiss=\"modal\" aria-hidden=\"true\">Close</button>\n        <button type = \"submit\" class=\"btn btn-primary\" >Save changes</button>\n    </div>\n  </div>\n</div>\n</div>\n</fieldset>\n</form>\n";
	},"useData":true});
